...
![This suggests a continuous reservoir rather than punctuated re-activation](files/EBOV_cds_mb_path.png){height=575px}

## Stable mutations arose in 2014 leading to increased infectivity

![](files/ebola_2014_variants.jpeg){height=575px}
...
![95% of cases have symptom onset within 21 days of exposure, mean incubation time is 11.4](files/ebola_incubation.jpeg){height=575px}
...
![](files/ebola_symptoms.jpeg){height=575px}
...
![](files/ebola_symptoms_2.jpeg){height=575px}

## Time course of the disease can be useful for treatment

![](files/ebola_timeline.png){height=575px}
...
![](files/EVD_stages.png){height=575px}

## In modern ICU, treatment varies widely and survival is better

![](files/EVD_critical.png){height=575px}
...
![](files/ebola_survivors_age_vl.jpeg){height=575px}
...
![](files/EVD_sequelae.png){height=575px}

# Infection control measures

## Infection control PPE protocol is extensive

![](files/ebola_ppe.png){height=575px}
...
![It was 100% effective, but it was completed as cases were dramatically declining](files/ebola_vaccine.png){height=575px}
