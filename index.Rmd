...
![](files/ebola_symptoms.jpeg){height=700px}
...
![](files/ebola_symptoms_2.jpeg){width=800px}

## Time course of the disease can be useful for treatment

![](files/ebola_timeline.png){height=800px}
...
## Treatment is based on a staging system
...
![](files/ebola_survivors.jpeg){width=900px}

## Young people with low viral load tend to survive: Sierra Leone

![](files/ebola_survivors_age_vl.jpeg){width=800px}

## However, there are many good mortality predictors

![](files/ebola_survivors_all.jpg){width=900px}
